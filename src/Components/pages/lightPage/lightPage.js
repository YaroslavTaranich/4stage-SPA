...
const lightAPI = [
    ...
    },
    {
        ...
        imgURL: artist,
        discription: 'Подберём необходимый комплект по вашему техническому заданию.',
        listTitle: 'В комлект входит:',
        setup: [
            "Robe Robin 600 LEDwash",
            "Robe Pointe 12R spot beam",
    ...
    },
    {
        ...
        imgURL: denGoroda,
        discription: 'Прикрепите к заказу техническое задание и мы подберём всё необходимое оборудование.',
        listTitle: 'В комлект входит:',
        setup: [
            "Robe Robin 600 LEDwash",
            "Robe Pointe 12R spot beam",
